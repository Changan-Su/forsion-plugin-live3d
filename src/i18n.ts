...
const zh = {
  ...
  // 3D 小屋(Space)与屏保
  'cmd.openRoom': 'Live3D:打开 3D 小屋',
  'cmd.saver': 'Live3D:启动屏保',
  'room.title': '3D 小屋',
  'room.scene': '场景',
  'room.builtin': '内置小屋',
  'room.sceneAuto': '自动(第一个场景)',
  'room.time': '昼夜',
  'room.time.auto': '跟随场景',
  'room.time.day': '白天',
  'room.time.night': '夜晚',
  'room.saver': '屏保',
  'room.newScene': '新建场景',
  'room.newSceneName': '我的小屋',
  'room.openScenes': '场景文件夹',
  'room.elsewhere': '3D 小屋正在屏保里显示',
  'room.loading': '住客正在进门…',
  'room.loadFailed': '住客「{name}」加载失败:{why}',
  'room.problems': '这些场景文件有问题:',
  'room.hint': '拖动转视角 · 滚轮缩放 · 双击复位 · 点一下角色',
  'room.walking': '正在过去:{what}',
  'room.created': '已新建场景 {path},改完保存即生效',
  'room.writeFailed': '写不进场景文件:{why}',
  'saver.title': '屏保',
  'saver.exitHint': '按任意键或点一下返回',
  'settings.room': '3D 小屋与屏保',
  'settings.roomHint': '左侧功能条里的「3D 小屋」Space:形象住在场景里自己过日子,Agent 干活时它也跟着去书桌前。场景文件放在 scenes/<名字>/scene.json。',
  'settings.saverOn': '空闲时显示屏保',
  'settings.saverHint': '只在 Forsion 窗口在前台、且这段时间里没有键盘鼠标操作时启动;按任意键、点一下或移动鼠标即退出。手动启动会进入系统全屏。',
  'settings.saverAfter': '空闲多久后启动',
  'settings.minutes': '{n} 分钟',
  'settings.saverStart': '现在启动屏保',
  'settings.openRoom': '打开 3D 小屋',

  // 姿势的通用描述(场景里的活动没写 label 时显示)
  'pose.stand': '发会儿呆',
  'pose.gaze': '望着窗外',
  'pose.telescope': '用望远镜看星星',
  'pose.browse': '在书架前挑书',
  'pose.view': '看墙上的东西',
  'pose.water': '照料花草',
  'pose.stretch': '伸懒腰',
  ...
  'pose.sit': '坐着歇会儿',
  'pose.sit-read': '坐着看书',
  'pose.sit-work': '在书桌前干活',
  'pose.sit-think': '托着腮想事情',
  'pose.sit-doze': '坐着睡着了',
  'pose.desk-sleep': '趴在桌上睡着了',
  'pose.piano': '弹钢琴',
  'pose.hug': '抱着玩偶',
  'pose.lie': '躺着发呆',
  'pose.sleep': '睡着了',
...
const en: Record<MsgKey, string> = {
  ...
  'cmd.openRoom': 'Live3D: Open the 3D room',
  'cmd.saver': 'Live3D: Start the screensaver',
  'room.title': '3D room',
  'room.scene': 'Scene',
  'room.builtin': 'Built-in room',
  'room.sceneAuto': 'Automatic (first scene)',
  'room.time': 'Time of day',
  'room.time.auto': 'Follow scene',
  'room.time.day': 'Day',
  'room.time.night': 'Night',
  'room.saver': 'Screensaver',
  'room.newScene': 'New scene',
  'room.newSceneName': 'My room',
  'room.openScenes': 'Scenes folder',
  'room.elsewhere': 'The 3D room is showing in the screensaver',
  'room.loading': 'The resident is moving in…',
  'room.loadFailed': 'Could not load the resident "{name}": {why}',
  'room.problems': 'These scene files have problems:',
  'room.hint': 'Drag to turn · scroll to zoom · double-click to reset · click the character',
  'room.walking': 'On the way: {what}',
  'room.created': 'Created scene {path}; edit it and save to see the change',
  'room.writeFailed': 'Could not write the scene file: {why}',
  'saver.title': 'Screensaver',
  'saver.exitHint': 'Press any key or click to return',
  'settings.room': '3D room and screensaver',
  'settings.roomHint': 'The "3D room" Space in the left bar: the avatar lives in a scene and goes about its day, and heads to the desk while the agent works. Scene files live in scenes/<name>/scene.json.',
  'settings.saverOn': 'Show the screensaver when idle',
  'settings.saverHint': 'Starts only while the Forsion window is in front and there has been no keyboard or mouse input for this long; any key, click or mouse movement brings you back. Starting it by hand goes full screen.',
  'settings.saverAfter': 'Start after',
  'settings.minutes': '{n} min',
  'settings.saverStart': 'Start the screensaver now',
  'settings.openRoom': 'Open the 3D room',

  'pose.stand': 'Standing around',
  'pose.gaze': 'Looking out of the window',
  'pose.telescope': 'Stargazing through the telescope',
  'pose.browse': 'Picking a book from the shelf',
  'pose.view': 'Looking at something on the wall',
  'pose.water': 'Tending the plants',
  'pose.stretch': 'Stretching',
  'pose.yawn': 'Yawning',
  'pose.nod-off': 'Dozing off on his feet',
  'pose.wave': 'Waving at you',
  'pose.talk': 'Talking to you',
  'pose.cheer': 'Cheering',
  'pose.sigh': 'Sighing',
  'pose.crouch': 'Crouching for a closer look',
  'pose.sit': 'Taking a seat',
  'pose.sit-read': 'Reading',
  'pose.sit-work': 'Working at the desk',
  'pose.sit-think': 'Thinking, chin in hand',
  'pose.sit-doze': 'Nodded off in the chair',
  'pose.desk-sleep': 'Asleep on the desk',
  'pose.piano': 'Playing the piano',
  'pose.hug': 'Hugging a plush toy',
  'pose.lie': 'Lying down',
  'pose.sleep': 'Asleep',
  'pose.sunbathe': 'Sunbathing',
}
